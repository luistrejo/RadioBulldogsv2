...
public class Calendarioadapter extends ListView {
    ...
    public Calendarioadapter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public Calendarioadapter(Context context, AttributeSet attrs, int defStyle) {
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = getAdapter().getView(position, pinnedShadow.view, Calendarioadapter.this);
        ...
        if (adjustForHeader) {
            post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (pinnedOffset > 0) {
                        Calendarioadapter.super.setSelectionFromTop(position, y + pinnedOffset);
                    }
                }
            });
        }
