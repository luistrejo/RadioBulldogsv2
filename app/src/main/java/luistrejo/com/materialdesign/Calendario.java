...
public class Calendario extends ListFragment implements View.OnClickListener {
    ...
    static class SimpleAdapter extends ArrayAdapter<Item> implements PinnedSectionListAdapter {
        ...
        public SimpleAdapter(Context context, int resource, int textViewResourceId) {
            ...
            final int sectionsNumber = 7;
            final String[] mes = {"Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio"};
            final String[][] fechas = {
                    {"7-8          Solicitud de papeletas (Pago de recurso)",
                            "9              Inscripción a Recursos",
                            "12-25     Capacitacion CENALTEC (Aéro-estructuras)     ",
                            "12-23     Recursos",
                    ...
                    {"2              Suspensión de Labores",
                            "3              Inicio de clases",
                            "3              Ceremonia Civica(T.M. 9:00 hrs, T.V. 16:45 hrs)",
                    ...
                    {"4 y 6       2° Academia Local",
                            "5              Suspensión de Labores",
                            "6              Ceremonia Civica T.M 9:00 hrs",
                            "7              Festejo del dia de las madres",
                            "8              2° Entrega de boletas",
                            "11-13     Supervision en aula",
                            "14           Festejo dia del Maestro",
                            "15           Suspension de Labores",
                            "22           Festejo dia del estudiante",
                            "25-29     3°era Evaluacion Parcial",
                            "26-29     Evaluacion de maestros nuevo ingreso",
                            "29-2       Captura 3°era Evaluación Parcial"},
                    {"1              Expo-Especialidades",
                            "1-4          3°era Academia Local",
                            "5              Entrega de boletas",
                            "8-12       Semana asesorías, Examen R.R.",
                            "11-12     Solicitud de R.R.",
                            "15-19     Examen R.R.",
                            "19-23     Aplicación R.R (Egresados, Bajas, etc.)",
                            "19-25     Captura de R.R.",
                            "24           Graduación",
                            "26           Solicitud de Recursos",
                            "29-10     Recursos"},
                    {"10-23     Captura Recursos",
                            "14           Fin de Curso"
